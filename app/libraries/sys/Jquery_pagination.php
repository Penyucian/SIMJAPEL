...
class Jquery_pagination {
    ...
    var $last_link = '>>';
    var $uri_segment = 3;
    var $full_tag_open = '<ul class="pagination paging">';
    var $full_tag_close = '</ul>';
    var $first_tag_open = '<li class="pagination_button">';
    var $first_tag_close = '</li>';
    var $last_tag_open = '<li class="pagination_button">';
    var $last_tag_close = '</li>';
    var $cur_tag_open = '<li class="pagination_button">';
    var $cur_tag_close = '</li>';
    var $next_tag_open = '<li class="pagination_button">';
    var $next_tag_close = '</li>';
    var $prev_tag_open = '<li class="pagination_button">';
    var $prev_tag_close = '</li>';
    var $num_tag_open = '<li class="pagination_button">';
    ...
    function create_links() {
        ...
        if ($this->show_count) {
            $curr_offset = intval($CI->uri->segment($this->uri_segment));
            $info = 'Show <b>' . ( $curr_offset + 1 ) . '</b> to <b>';
        ...
        for ($loop = $start - 1; $loop <= $end; $loop++) {
            ...
            if ($i >= 0) {
                if ($this->cur_page == $loop) {
                    $output .= "<li class='pagination_button active'>" . $this->getAJAXlink(0, $loop) . $this->num_tag_close;
                } else {
                    $n = ($i == 0) ? 0 : $i;
