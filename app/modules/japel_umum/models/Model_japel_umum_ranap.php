 ...
 */
class Model_japel_umum_ranap extends CI_Model
{
    public $dbSimrs;
    ...
    public function get_data_ranap($param = [])
    {
        ...
        if(!empty($param['clinic_id'])){
            $this->dbSimrs->where_in('kd.owner_clinic_id', $param['clinic_id']);
        }
