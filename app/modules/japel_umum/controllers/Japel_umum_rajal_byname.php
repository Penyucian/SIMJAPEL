...
class Japel_umum_rajal_byname extends SYS_Controller
{
    private $data;
    ...
    {
        parent::__construct();
        $this->load->model('model_japel_umum_rajal_byname');
        $this->data['controller'] = 'japel_umum/japel_umum_rajal_byname/';
    }
    ...
    {
        $this->data['param'] = $this->input->post();
        $this->data['content'] = $this->model_japel_umum_rajal_byname->get_data_rajal($this->data)->result_array();
    ...
    public function export()
    {
        ...
        $data = $this->model_japel_umum_rajal_byname->get_data_rajal($this->data)->result_array();
