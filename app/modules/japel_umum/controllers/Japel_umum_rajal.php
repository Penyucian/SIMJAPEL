...
class Japel_umum_rajal extends SYS_Controller
{
    private $data;
    ...
    {
        parent::__construct();
        $this->load->model('model_japel_umum_rajal');
        $this->load->model('model_ref_clinic');
        $this->load->model('model_doctor_ref');
        $this->data['controller'] = 'japel_umum/japel_umum_rajal/';
    ...
    public function get_data()
    {
        ...
        $this->data['content'] = $this->model_japel_umum_rajal->get_data_rajal($this->data)->result_array();
    ...
    public function export()
    {
        ...
        $data = $this->model_japel_umum_rajal->get_data_rajal($this->data)->result_array();
