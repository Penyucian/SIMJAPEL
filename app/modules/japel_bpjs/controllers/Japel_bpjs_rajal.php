...
class Japel_bpjs_rajal extends SYS_Controller
{
    private $data;
    ...
    {
        parent::__construct();
        $this->load->model('model_japel_bpjs_rajal');
        $this->load->model('model_ref_clinic');
        $this->data['controller'] = 'japel_bpjs/japel_bpjs_rajal/';
    ...
    {
        $this->data['content'] = $this->model_japel_bpjs_rajal->get_data_rajal($this->data)->result_array();
