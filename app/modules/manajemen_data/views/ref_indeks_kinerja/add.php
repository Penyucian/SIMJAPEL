<div id='modal-data-basic'>
    ...
    <form rel='ajax-datatable' id="form_modal" class="form-horizontal xhr dest_modal-data-basic" method="post" action="<?php echo site_url($url_action); ?>">
        <div class="row form-group">
            <label class="col-sm-3 control-label" style="text-align:left;">Indeks Kinerja <span style='color:red;'><b>*</b></span></label>
            <div class="col-sm-9">
                <input type="text" name="dt[name]" class="form-control" value="<?php echo (!empty($content['name'])) ? $content['name'] : set_value('dt[name]'); ?>" placeholder="Indeks Kinerja">
            </div>
        </div>
        <div class="row form-group">
