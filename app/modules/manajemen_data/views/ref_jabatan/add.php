<div id='modal-data-basic'>
    ...
    <form rel='ajax-datatable' id="form_modal" class="form-horizontal xhr dest_modal-data-basic" method="post" action="<?php echo site_url($url_action); ?>">
        <div class="row form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="dt[name]" class="form-control" value="<?php echo (!empty($content['name'])) ? $content['name'] : set_value('dt[name]'); ?>" placeholder="Jabatan">
            </div>
        </div>
        <div class="row form-group">
        ...
        <div class="row form-group">
            <label class="col-sm-3 control-label" style="text-align:left;">Persen Bagian <span style='color:red;'><b>*</b></span></label>
            <div class="col-sm-9">
                <input type="text" name="dt[index_persentase]" class="form-control" value="<?php echo (!empty($content['index_persentase'])) ? $content['index_persentase'] : set_value('dt[index_persentase]'); ?>" placeholder="Persen Bagian">
            </div>
        </div>
        <hr />
