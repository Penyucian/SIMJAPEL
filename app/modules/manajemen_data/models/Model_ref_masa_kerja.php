<?php
class Model_ref_masa_kerja extends CI_Model
{
    public $dbSimrs;
    ...
    public function get_row($param = [])
    {
        ...
        $this->dbSimrs->from('ref_masa_kerja a');
    ...
    public function get_data($param)
    {
        ...
        $this->datatables->from('ref_masa_kerja rj');
        $this->datatables->action(
            [
                [
                    ...
                    'key' => 'id',
                    'title' => 'Edit Referensi Masa Kerja',
                ],
                [
                    'action' => 'delete',
    ...
    {
        return $this->dbSimrs->insert('ref_masa_kerja', $data);
    }
    ...
    public function update_data($data, $param = [])
    {
        ...
        return $this->dbSimrs->update('ref_masa_kerja', $data);
    }
    ...
    public function delete_data($param = [])
    {
        ...
        return $this->dbSimrs->delete('ref_masa_kerja');
    }
}
