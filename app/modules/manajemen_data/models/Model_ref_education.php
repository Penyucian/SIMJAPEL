<?php
class Model_ref_education extends CI_Model
{
    public $dbSimrs;
    ...
    public function get_row($param = [])
    {
        ...
        $this->dbSimrs->from('ref_educations a');
        $this->dbSimrs->order_by('order');
    ...
    public function get_data($param)
    {
        ...
        $this->datatables->from('ref_educations rj');
        $this->datatables->order_by('rj.order');
    ...
    {
        return $this->dbSimrs->insert('ref_educations', $data);
    }
    ...
    public function update_data($data, $param = [])
    {
        ...
        return $this->dbSimrs->update('ref_educations', $data);
    }
    ...
    public function delete_data($param = [])
    {
        ...
        return $this->dbSimrs->delete('ref_educations');
    }
}
