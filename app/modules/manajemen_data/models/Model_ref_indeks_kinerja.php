<?php
class Model_ref_indeks_kinerja extends CI_Model
{
    public $dbSimrs;
    ...
    public function get_row($param = [])
    {
        ...
        $this->dbSimrs->from('ref_indeks_kinerja a');
    ...
    public function get_data($param)
    {
        ...
        $this->datatables->from('ref_indeks_kinerja rj');
        $this->datatables->action(
            [
                [
                    ...
                    'key' => 'id',
                    'title' => 'Edit Referensi Indeks Kinerja',
                ],
                [
                    'action' => 'delete',
    ...
    {
        return $this->dbSimrs->insert('ref_indeks_kinerja', $data);
    }
    ...
    public function update_data($data, $param = [])
    {
        ...
        return $this->dbSimrs->update('ref_indeks_kinerja', $data);
    }
    ...
    public function delete_data($param = [])
    {
        ...
        return $this->dbSimrs->delete('ref_indeks_kinerja');
    }
}
