...
<form rel='ajax' action="<?php echo site_url('sys/menu/add_menu_proses'); ?>" class="panel form-horizontal xhr dest_subcontent-element" method="post">  
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-2">
                        <select class="form-control" name="is_aktif">
                            <option value="1" <?php echo set_select('is_aktif','1',false) ?>>Ya</option>
                            <option value="0"  <?php echo set_select('is_aktif','0',false) ?>>Tidak</option>
                        </select>
                    </div>      
                </div>
