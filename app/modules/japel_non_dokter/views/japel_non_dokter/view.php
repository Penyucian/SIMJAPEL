    ...
    <div class="panel-body">
        <form id="datatables_filter" class="form-horizontal">
            ...
            <div class="text-right">
                <button type="button" id="btn-generate" class="btn btn-success"><span class="btn-label-icon left fa fa-magic"></span>Generate</button>
            ...
            <table class="table table-striped table-bordered" id="datatables">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Nominal Japel</th>
                    </tr>
                </thead>
